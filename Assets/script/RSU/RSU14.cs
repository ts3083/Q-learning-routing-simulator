...
public class RSU14 : MonoBehaviour
{
    private int current_RSU = 14;
    ...
    private int[] actions_RSU = new int[actionNum] { 9, 15, 20, 19, 13 };

    // RSU9 방향 좌표 저장
    private Vector3[] forward_RSU9 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(623.796f, 0.427f, 297.49f), new Vector3(621.62f, 0.427f, 297.49f) };

    // RSU13 방향 좌표 저장
    private Vector3[] forward_RSU13 = new Vector3[5] { new Vector3(0, 0, 0), new Vector3(612.509f, 0.427f, 311.59f), new Vector3(612.509f, 0.427f, 313.86f), new Vector3(612.509f, 0.427f, 316.13f), new Vector3(612.509f, 0.427f, 318.39f) };

    // RSU15 방향 좌표 저장
    private Vector3[] forward_RSU15 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(637.5f, 0.427f, 303.802f), new Vector3(637.5f, 0.427f, 301.586f) };

    // RSU19 방향 좌표 저장
    private Vector3[] forward_RSU19 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(621.223f, 0.427f, 322.507f), new Vector3(623.4f, 0.427f, 322.507f) };

    // RSU20 방향 좌표 저장
    private Vector3[] forward_RSU20 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(637.86f, 0.427f, 320.41f), new Vector3(640.07f, 0.427f, 318.2f) };
    ...
    private Vector3 getPosition(int RSU_num)
    {
        ...
        if (prev_RSU == 9)
        {
            switch (RSU_num)
            {
                ...
                case 15:
                    return forward_RSU15[line_num];      // 왼쪽(반시계) 방향으로 135º 회전
                case 19:
        ...
        else if (prev_RSU == 13)
        {
            ...
            switch (RSU_num)
            {
                ...
                case 15:
                    return forward_RSU15[line_num];
                case 19:
                    return forward_RSU19[line_num];       // 오른쪽(시계) 방향으로 45º 회전
                case 20:
                    return forward_RSU20[line_num];
                default:
                    return forward_RSU9[line_num];
        ...
        else if (prev_RSU == 15)
        {
            switch (RSU_num)
            {
                ...
                case 13:
                    line_num = Random.Range(1, 5);
                    return forward_RSU13[line_num];       // 왼쪽(반시계) 방향으로 45º 회전
                case 19:
                    return forward_RSU19[line_num];       // 왼쪽(반시계) 방향으로 135º 회전
                case 20:
                    return forward_RSU20[line_num];       // 오른쪽(시계) 방향으로 45º 회전
                default:
                    return forward_RSU9[line_num];
            }
        }
        ...
        else
        {
            switch (RSU_num)
            {
                ...
                case 15:
                    return forward_RSU15[line_num];
                case 19:
                    return forward_RSU19[line_num];      // 오른쪽(시계) 방향으로 135º 회전
                default:
                    return forward_RSU9[line_num];
            }
        }
