...
public class RSU19 : MonoBehaviour
{
    private int current_RSU = 19;       // 현재 RSU
    ...
    private int[] actions_RSU = new int[actionNum] { 14, 20, 24, 18 };

    // RSU14 방향 좌표 저장
    private Vector3[] forward_RSU14 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(618.782f, 0.427f, 612.491f), new Vector3(616.595f, 0.427f, 612.491f) };

    // RSU18 방향 좌표 저장
    private Vector3[] forward_RSU18 = new Vector3[5] { new Vector3(0, 0, 0), new Vector3(602.5f, 0.427f, 621.57f), new Vector3(602.5f, 0.427f, 623.85f), new Vector3(602.5f, 0.427f, 626.15f), new Vector3(602.5f, 0.427f, 628.39f) };

    // RSU20 방향 좌표 저장
    private Vector3[] forward_RSU20 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(627.503f, 0.427f, 618.78f), new Vector3(627.503f, 0.427f, 616.6f) };

    // RSU24 방향 좌표 저장
    private Vector3[] forward_RSU24 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(621.231f, 0.427f, 627.502f), new Vector3(623.379f, 0.427f, 627.502f) };
