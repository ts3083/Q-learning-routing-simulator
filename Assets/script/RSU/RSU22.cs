...
public class RSU22 : MonoBehaviour
{
    private int current_RSU = 22;       // 현재 RSU
    ...
    private int[] actions_RSU = new int[actionNum] { 21, 17, 18, 23 };

    // RSU17 방향 좌표 저장
    private Vector3[] forward_RSU17 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(-6.214f, 0.427f, 922.503f), new Vector3(-8.39f, 0.427f, 922.503f) };

    // RSU18 방향 좌표 저장
    private Vector3[] forward_RSU18 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(10.45f, 0.427f, 922.12f), new Vector3(8.27f, 0.427f, 919.94f) };

    // RSU21 방향 좌표 저장
    private Vector3[] forward_RSU21 = new Vector3[5] { new Vector3(0, 0, 0), new Vector3(-12.5f, 0.427f, 936.51f), new Vector3(-12.5f, 0.427f, 938.841f), new Vector3(-12.5f, 0.427f, 941.152f), new Vector3(-12.5f, 0.427f, 943.385f) };

    // RSU23 방향 좌표 저장
    private Vector3[] forward_RSU23 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(12.498f, 0.427f, 938.76f), new Vector3(12.498f, 0.427f, 936.569f) };
    ...
    public Vector3 getPosition(int RSU_num)
    {
        ...
        if (prev_RSU == 17)
        {
            switch (RSU_num)
            {
                ...
                case 21:
                    ...
                    return forward_RSU21[line_num];       // 왼쪽(반시계) 방향으로 135º 회전
                case 23:
        ...
        else if (prev_RSU == 18)
        {
            switch (RSU_num)
            {
                ...
                case 21:
                    line_num = Random.Range(1, 5);
                    return forward_RSU21[line_num];      // 오른쪽(시계) 방향으로 45º 회전
                case 23:
                    return forward_RSU23[line_num];
                default:
                    return forward_RSU17[line_num];
        ...
        else if (prev_RSU == 21)
        {
            ...
            switch (RSU_num)
            {
                ...
                case 18:
                    return forward_RSU18[line_num];       // 왼쪽(반시계) 방향으로 45º 회전
                case 23:
        ...
        else
        {
            switch (RSU_num)
            {
                ...
                case 21:
                    line_num = Random.Range(1, 5);
                    return forward_RSU21[line_num];      // 오른쪽(시계) 방향으로 135º 회전
                default:
                    return forward_RSU17[line_num];
            }
        }
