...
public class RSU24 : MonoBehaviour
{
    private int current_RSU = 24;       // 현재 RSU
    ...
    private int[] actions_RSU = new int[actionNum] { 23, 19, 25 };

    // RSU25방향 좌표 저장
    private Vector3[] forward_RSU25 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(627.24f, 0.427f, 938.73f), new Vector3(627.24f, 0.427f, 936.63f) };

    // RSU19방향 좌표 저장
    private Vector3[] forward_RSU19 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(618.76f, 0.427f, 932.7f), new Vector3(616.61f, 0.427f, 932.7f) };

    // RSU23방향 좌표 저장
    private Vector3[] forward_RSU23 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(612.7f, 0.427f, 941.16f), new Vector3(612.7f, 0.427f, 943.4f) };
