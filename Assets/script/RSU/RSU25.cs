...
public class RSU25 : MonoBehaviour
{
    private int current_RSU = 25;       // 현재 RSU
    ...
    private int[] actions_RSU = new int[actionNum] { 24, 20 };

    // RSU20 방향 좌표 저장
    private Vector3[] forward_RSU20 = new Vector3[5] { new Vector3(0, 0, 0), new Vector3(928.33f, 0.427f, 932.66f), new Vector3(926.14f, 0.427f, 932.66f), new Vector3(923.89f, 0.427f, 932.66f), new Vector3(921.72f, 0.427f, 932.66f) };

    // RSU24 방향 좌표 저장
    private Vector3[] forward_RSU24 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(917.68f, 0.427f, 941.19f), new Vector3(917.68f, 0.427f, 943.36f) };
