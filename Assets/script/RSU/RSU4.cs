...
public class RSU4 : MonoBehaviour
{
    private int current_RSU = 4;        // 현재 RSU
    ...
    private int[] actions_RSU = new int[actionNum] { 3, 5, 8, 9 };

    // RSU3 방향 좌표 저장
    private Vector3[] forward_RSU3 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(607.47f, 0.427f, -313.76f), new Vector3(607.47f, 0.427f, -311.62f) };

    // RSU5 방향 좌표 저장
    private Vector3[] forward_RSU5 = new Vector3[5] { new Vector3(0, 0, 0), new Vector3(632.51f, 0.427f, -311.53f), new Vector3(632.51f, 0.427f, -313.83f), new Vector3(632.51f, 0.427f, -316.12f), new Vector3(632.51f, 0.427f, -318.377f) };

    // RSU8 방향 좌표 저장
    private Vector3[] forward_RSU8 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(608.7f, 0.427f, -296.3f), new Vector3(610.91f, 0.427f, -294.09f) };

    // RSU9 방향 좌표 저장
    private Vector3[] forward_RSU9 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(626.21f, 0.427f, -297.497f), new Vector3(628.397f, 0.427f, -297.497f) };
