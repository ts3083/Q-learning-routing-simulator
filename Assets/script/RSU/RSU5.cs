...
public class RSU5 : MonoBehaviour
{
    ...
    // RSU4 방향 좌표 저장
    private Vector3[] forward_RSU4 = new Vector3[5] { new Vector3(0, 0, 0), new Vector3(927.496f, 0.427f, -308.463f), new Vector3(927.496f, 0.427f, -306.17f), new Vector3(927.496f, 0.427f, -303.855f), new Vector3(927.496f, 0.427f, -301.654f) };

    // RSU10 방향 좌표 저장
    private Vector3[] forward_RSU10 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(936.253f, 0.427f, -297.497f), new Vector3(938.376f, 0.427f, -297.497f) };
