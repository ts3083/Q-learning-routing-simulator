...
public class RSU9 : MonoBehaviour
{
    private int current_RSU = 9;        // 현재 RSU
    ...
    private int[] actions_RSU = new int[actionNum] { 4, 8, 10, 14 };

    // RSU4 방향 좌표 저장
    private Vector3[] forward_RSU4 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(623.767f, 0.427f, -7.506f), new Vector3(621.619f, 0.427f, -7.506f) };

    // RSU8 방향 좌표 저장
    private Vector3[] forward_RSU8 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(617.49f, 0.427f, 1.223f), new Vector3(617.49f, 0.427f, 3.378f) };

    // RSU10 방향 좌표 저장
    private Vector3[] forward_RSU10 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(632.5f, 0.427f, -1.226f), new Vector3(632.5f, 0.427f, -3.383f) };

    // RSU14 방향 좌표 저장
    private Vector3[] forward_RSU14 = new Vector3[3] { new Vector3(0, 0, 0), new Vector3(626.249f, 0.427f, 7.499f), new Vector3(628.39f, 0.427f, 7.499f) };
